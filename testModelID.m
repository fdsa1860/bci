% model id based method classification
...
%     end
    pEst=modelId(ytrain,trainLabels);
    ...
    for i=1:size(ytest,2)        
        ...
        H=hankel_mo(ytest(:,i)',[order+1 length(ytest(:,i))-order]);
        e=H'*[pEst;-1 -1 -1 -1];
        d_all=[norm(e(:,1),2) norm(e(:,2),2) norm(e(:,3),2) norm(e(:,4),2)];       
